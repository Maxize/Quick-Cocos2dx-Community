...
--------------------------------
-- Unzip the zip file to the specified path<br>
-- param zipPath The path of the zip file, it could be an absolute path.<br>
-- param dirPath The path of directory, it could be an absolute path.<br>
-- param password The password of the zip file<br>
